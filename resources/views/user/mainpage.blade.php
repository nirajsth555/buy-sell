...
<div class="mobile-app">
				<div class="container">
					<div class="col-md-5 app-left">
						<a href="mobileapp.html"><img src="{{url('public/user/images/app.png')}}" alt=""></a>
					</div>
					<div class="col-md-7 app-right">
						...
						<div class="app-buttons">
							<div class="app-button">
								<a href="#"><img src="{{url('public/user/images/1.png')}}" alt=""></a>
							</div>
							<div class="app-button">
								<a href="#"><img src="{{url('public/user/images/2.png')}}" alt=""></a>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
